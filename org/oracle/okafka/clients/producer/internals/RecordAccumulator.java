...
public final class RecordAccumulator {
    ...
    public int splitAndReenqueue(ProducerBatch bigBatch) {
        ...
        while (!dq.isEmpty()) {
            ...
            synchronized (partitionDequeue) { 
            	//Changes for 2.8.1:: transactionManager not supported by Oracle Kafka
            	/*
                if (transactionManager != null) {
    ...
    /*
     * Changes for 2.8.1 :: Method used with TransactionManager only. Commented out
...
*/
    ...
    private boolean shouldStopDrainBatchesForPartition(ProducerBatch first, TopicPartition tp) {
    	// Changes for 2.8.1 :: Trnasaction Manager not supported
        ...
        do {
            ...
            synchronized (deque) {
                ...
                if (size + first.estimatedSizeInBytes() > maxSize && !ready.isEmpty()) {
                  ...
                  //Changes for 2.8.1:: Transaction Manager not supported
                    /*
